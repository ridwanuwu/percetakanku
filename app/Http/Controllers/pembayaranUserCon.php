...
class pembayaranUserCon extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pembayaranUser.index', compact('bayars','menu','nomerdet'));
    }
    ...
    public function create()
    {
        ...
        return view('pembayaranUser.create', compact('bayars','pegawai','pelanggan','nomer','pesans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bayarUser.index')->with('success','Data Berhasil di Input');
    }
