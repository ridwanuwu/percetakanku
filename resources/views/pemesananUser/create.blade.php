...
<form action="{{ route('pesanUser.store') }}" method="post">
    @csrf
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Tambah Data Pemesanan</h5>
            <form class="">
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group"><label class="">Pelanggan</label>
                            <select name="NO_PELANGGAN" id="NO_PELANGGAN" class="form-control" readonly>
                ...
                <a href="{{ route('pesanUser.index') }}" class="btn btn-md btn-secondary">Back</a>
            </form>
        </div>
    </div>
</form>
