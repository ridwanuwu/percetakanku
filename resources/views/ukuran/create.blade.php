...
<form action="{{ route('bahan.store') }}" method="post">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Tambah Data Bahan</h5>
            <form class="">
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group"><label class="">ID Bahan</label><input name="ID_PEMESANAN" type="text" class="form-control" readonly  value="{{ $nomer }}"></div>
                    </div>
                    <div class="col-md-6">
